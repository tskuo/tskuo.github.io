...
I am a 5th-year PhD candidate in the [Human-Computer Interaction Institute](https://www.hcii.cmu.edu/) at Carnegie Mellon University, where I am grateful to be co-advised by [Ken Holstein](https://kenholstein.com/) and [Haiyi Zhu](https://haiyizhu.com/), with additional guidance from my committee members: [Amy X. Zhang](https://homes.cs.washington.edu/~axz/), [Niki Kittur](https://kittur.org/), and [Michael Bernstein](https://hci.stanford.edu/msb/). I am currently a student researcher at Google DeepMind, working with [Michael Terry](https://research.google/people/107786/) and [Merrie Morris](https://research.google/people/meredithringelmorris/).
