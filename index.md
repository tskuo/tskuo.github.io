...
AI is rewiring society's digital infrastructure, making vital decisions across online communities and public agencies. But who gets to shape this technology? I envision a future where AI is shaped by the people it serves, who best understand their own context, rather than relying on external developers who lack the domain knowledge to address local needs. As an HCI researcher combining system building, participatory design, and responsible AI, I build toward this future by creating interactive systems that empower people to harness their collective intelligence, aligning AI with their local needs, cultural values, and lived experiences.

My research has impact across academia, industry, and policy. I publish at top HCI and AI venues like CHI, NeurIPS, and FAccT, with 4 Best Paper and Honorable Mention awards. I am both a [Rising Star in ML & Systems](https://mlcommons.org/about-us/programs/) and a [Rising Star in Data Science](https://datascience.uchicago.edu/research/postdoctoral-programs/rising-stars/). I am also CMU's [Presidential Fellow in Ethics & Computational Technologies](https://www.cmu.edu/ethics-ai/news/2025-fellows.html) and inaugural [Fellow on AI & Society](https://www.cmu.edu/block-center/our-work/block-ai-society-fellowship). Beyond academia, I work closely with industry partners like Microsoft and Google DeepMind, civic initiatives like MetaGov and the Wikimedia Foundation, and local communities in Pittsburgh and Taiwan. My research informs policy reports from the European Parliament and White House Office of Science & Technology Policy.
